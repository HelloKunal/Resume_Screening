from resume_rating import docx_processing  as doc, textract_processing as txt
from resume_rating import tf_idf_cosine_similarity as tf_idf,doc2vec_comparison as d2v
